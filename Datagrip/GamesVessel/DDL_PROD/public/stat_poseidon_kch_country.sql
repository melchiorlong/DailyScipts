...
alter table public.stat_poseidon_kch_country owner to gv_root;
...
grant select on public.stat_poseidon_kch_country to metabase;

grant select on public.stat_poseidon_kch_country to gv_developer;
