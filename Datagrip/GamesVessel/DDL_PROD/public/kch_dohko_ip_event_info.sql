...
alter table public.kch_dohko_ip_event_info owner to gv_root;
...
grant select on public.kch_dohko_ip_event_info to metabase;

grant select on public.kch_dohko_ip_event_info to gv_developer;
