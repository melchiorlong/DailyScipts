...
alter table public.mid_ilrd_quality_check_dau owner to gv_offline_rw;
...
grant select on public.mid_ilrd_quality_check_dau to metabase;

grant select on public.mid_ilrd_quality_check_dau to gv_developer;
