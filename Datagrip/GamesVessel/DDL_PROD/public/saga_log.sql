...
(
	...
	combo3 integer encode az64,
	combo4 integer encode az64,
	combo5 integer encode az64,
	combo6 integer encode az64,
	combo7 integer encode az64,
	hammer_times integer encode az64
)
sortkey(action_time);

alter table public.saga_log owner to gv_root;
...
grant select on public.saga_log to metabase;

grant select on public.saga_log to gv_developer;
