...
alter table public.mid_dh_flurry_daily_usage owner to gv_root;
...
grant select on public.mid_dh_flurry_daily_usage to metabase;

grant select on public.mid_dh_flurry_daily_usage to gv_developer;
