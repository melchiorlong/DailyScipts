...
alter table public.mid_dohko_item_score_detail owner to gv_root;
...
grant select on public.mid_dohko_item_score_detail to metabase;

grant select on public.mid_dohko_item_score_detail to gv_developer;
