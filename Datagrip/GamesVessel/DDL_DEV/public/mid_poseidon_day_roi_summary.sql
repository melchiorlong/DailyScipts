...
alter table public.mid_poseidon_day_roi_summary owner to awsuser;
...
grant select on public.mid_poseidon_day_roi_summary to gv_alert;

grant select on public.mid_poseidon_day_roi_summary to dev_user;
