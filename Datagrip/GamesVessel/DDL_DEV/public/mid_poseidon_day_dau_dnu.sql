...
alter table public.mid_poseidon_day_dau_dnu owner to awsuser;
...
grant select on public.mid_poseidon_day_dau_dnu to gv_alert;

grant select on public.mid_poseidon_day_dau_dnu to dev_user;
