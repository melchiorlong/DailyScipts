...
alter table public.stat_poseidon_coin_analysis_balance owner to awsuser;
...
grant select on public.stat_poseidon_coin_analysis_balance to gv_alert;

grant select on public.stat_poseidon_coin_analysis_balance to dev_user;
