...
alter table public.dim_poseidon_ua_meta owner to awsuser;
...
grant select on public.dim_poseidon_ua_meta to gv_alert;

grant select on public.dim_poseidon_ua_meta to dev_user;
