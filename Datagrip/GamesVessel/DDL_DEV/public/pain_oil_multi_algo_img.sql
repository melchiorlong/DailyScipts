...
alter table public.pain_oil_multi_algo_img owner to awsuser;
...
grant select on public.pain_oil_multi_algo_img to gv_alert;

grant select on public.pain_oil_multi_algo_img to dev_user;
