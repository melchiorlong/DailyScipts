...
alter table public.mid_ilrd_should_display owner to awsuser;
...
grant select on public.mid_ilrd_should_display to gv_alert;

grant select on public.mid_ilrd_should_display to dev_user;
