...
alter table public.stat_poseidon_log_country owner to awsuser;
...
grant select on public.stat_poseidon_log_country to gv_alert;

grant select on public.stat_poseidon_log_country to dev_user;
