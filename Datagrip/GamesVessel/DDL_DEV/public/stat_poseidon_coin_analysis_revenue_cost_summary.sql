...
alter table public.stat_poseidon_coin_analysis_revenue_cost_summary owner to awsuser;
...
grant select on public.stat_poseidon_coin_analysis_revenue_cost_summary to gv_alert;

grant select on public.stat_poseidon_coin_analysis_revenue_cost_summary to dev_user;
