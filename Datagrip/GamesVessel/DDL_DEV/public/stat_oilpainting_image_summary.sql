...
alter table public.stat_oilpainting_image_summary owner to awsuser;
...
grant select on public.stat_oilpainting_image_summary to gv_alert;

grant select on public.stat_oilpainting_image_summary to dev_user;
