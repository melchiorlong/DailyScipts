...
class applovin_reward_video_4iOS_calc:
    ...
    def get_country_filter(self):
        ...
        # country_map = {'aiolos_ip': ['US', 'SA', 'BR']}
        ...
        for app_name in self._app_list:
            sql_statement = """
                ...
                type_temp as (
                    select 
                        info.muid,
                        sum(impr_count) as impr_type
                    from temp_applovin_ios_poseidon_log log
                ...
                select 
                    ...
                    sum(muid_count) over (partition by country order by impr_type rows between current row and unbounded following) as sum_count,
                    info.app_name
                from 
                    temp_applovin_ios_poseidon_log log
                inner join
...
if __name__ == '__main__':
    ...
    app = applovin_reward_video_4iOS_calc()
