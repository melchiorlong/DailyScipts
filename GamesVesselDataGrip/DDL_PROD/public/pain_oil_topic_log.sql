...
alter table public.pain_oil_topic_log owner to gv_offline_rw;
...
grant select on public.pain_oil_topic_log to metabase;

grant select on public.pain_oil_topic_log to gv_developer;
