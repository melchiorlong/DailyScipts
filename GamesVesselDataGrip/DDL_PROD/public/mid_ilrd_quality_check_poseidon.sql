...
alter table public.mid_ilrd_quality_check_poseidon owner to gv_offline_rw;
...
grant select on public.mid_ilrd_quality_check_poseidon to metabase;

grant select on public.mid_ilrd_quality_check_poseidon to gv_developer;
