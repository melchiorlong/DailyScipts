...
alter table public.kch_aiolos_ip_install_info owner to gv_root;
...
grant select on public.kch_aiolos_ip_install_info to metabase;

grant select on public.kch_aiolos_ip_install_info to gv_developer;
