...
alter table public.stat_poseidon_coin_analysis_revenue_cost owner to awsuser;
...
grant select on public.stat_poseidon_coin_analysis_revenue_cost to gv_alert;

grant select on public.stat_poseidon_coin_analysis_revenue_cost to dev_user;
