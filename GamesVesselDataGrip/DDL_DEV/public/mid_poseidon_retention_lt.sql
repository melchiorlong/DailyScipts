...
alter table public.mid_poseidon_retention_lt owner to awsuser;
...
grant select on public.mid_poseidon_retention_lt to gv_alert;

grant select on public.mid_poseidon_retention_lt to dev_user;
