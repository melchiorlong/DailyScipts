...
(
	...
	constraint mid_ilrd_campaign_roi_total_rev_pkey
		primary key (campaign_id, bj_date, country)
);

alter table public.mid_ilrd_campaign_roi_total_rev owner to awsuser;
...
grant select on public.mid_ilrd_campaign_roi_total_rev to gv_alert;

grant select on public.mid_ilrd_campaign_roi_total_rev to dev_user;
