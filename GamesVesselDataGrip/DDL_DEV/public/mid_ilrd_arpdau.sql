...
alter table public.mid_ilrd_arpdau owner to awsuser;
...
grant delete, insert, references, select, trigger, update on public.mid_ilrd_arpdau to gv_offline_rw;

grant select on public.mid_ilrd_arpdau to gv_alert;

grant select on public.mid_ilrd_arpdau to dev_user;
