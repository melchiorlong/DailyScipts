...
(
	...
	rev_fb double precision,
	impr bigint encode az64,
	fb_rev double precision
);

alter table public.mid_ilrd_quality_check_dh owner to awsuser;
...
grant delete, insert, references, select, trigger, update on public.mid_ilrd_quality_check_dh to gv_offline_rw;

grant select on public.mid_ilrd_quality_check_dh to gv_alert;

grant select on public.mid_ilrd_quality_check_dh to dev_user;
