...
alter table public.mid_poseidon_day_ad_revenue owner to awsuser;
...
grant select on public.mid_poseidon_day_ad_revenue to gv_alert;

grant select on public.mid_poseidon_day_ad_revenue to dev_user;
